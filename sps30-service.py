...
configDataPath = '/meetfietsApp/Meetfiets/sps30data.ini' # CHANGE THIS FI YOU HAVE CHANGED THE LOCATION
config = configparser.ConfigParser()
config.read(configDataPath) 
...
def putInConfigFile(data):
    ...
    config['pm10']['count'] = str(int(calcFloat(data[48:54])))
    config['pm10']['ug'] = str(int(calcFloat(data[18:24])))
    config['pm']['type'] = str(int(calcFloat(data[54:60])))
